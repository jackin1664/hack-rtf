<template>
    <div class="mt-5 ui-card px-4 py-3">
        <div class="num-box d-flex justify-content-between flex-wrap">
            ...
            {{token_data.token_symbol}}
                ...
                <div class="d-flex align-items-center">
                    <h4 class="mr-2 mb-1">
                        {{num_balance_true | tofixed6 | parsefloat}}
                    </h4>
                    <span>
            TRUE
          </span>
    ...
    export default {
        ...
        methods: {
            async getBalance(){
                ...
                let contract = new v.myWeb3.eth.Contract(swapPoolAbi, trc20_address)
                ...
                v.myWeb3.eth.getBalance(local_address).then(function(result){
                    let balance = new Decimal(result).div(Math.pow(10,decimals)).toFixed()
                    console.log('balance true result',balance)
                    v.num_balance_true = balance
                })
                // var t = v.tronWebRead
